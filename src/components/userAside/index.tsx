...
function UserAside({ active }: { active: number }) {
  ...
  return (
    <section className="">
          ...
          <div className="flex gap-3 items-center">
            ...
            >
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <g clipPath="url(#clip0_481_12649)">
                  <path
            ...
            >
              ...
              >
                ...
                <path
                  ...
                  strokeLinecap="round"
                />
                <rect x="16" width="8" height="8" rx="4" fill="#FD0769" />
              </svg>
            </div>
            <div className="self-stretch my-auto w-[182px] lg:block">
      ...
      {/* <Link to={`/${lang}/${ROUTES.return[lang as keyof typeof ROUTES.return]}`}>
        <div
          className={`flex w-full lg:h-[56px] h-fit overflow-hidden flex-col text-black justify-center p-1 ${active === 5 ? 'bg-[#B1C7E4]' : 'bg-white'
            } rounded-3xl mt-2`}>
          <div className="flex gap-3 items-center">
            <div className={`p-2 rounded-full ${active === 3 ? 'bg-white' : 'bg-[#F5F5F5]'}`}>
              <GrReturn size={24} />
            </div>
            <div className="self-stretch my-auto w-[182px] lg:block">{translation?.return}</div>
          </div>
        </div>
      </Link> */}
      {/* feature link */}
