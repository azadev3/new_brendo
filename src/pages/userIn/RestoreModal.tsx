                ...
                <div className="container-with-result">
                    ...
                    >
                        <div className="inputs">
                            ...
                            <input
                                type="email"
                                placeholder='İlahanazarli@gmail.com'
                            ...
                            <input
                                type="text"
                                placeholder='Bakı, Yasamal, Əsəd Əhmədova 181A'
                            ...
                            <select
                                ...
                                onChange={(e: ChangeEvent<HTMLSelectElement>) => setReturnReasonId(e.target.value)}
                                value={returnReasonId}
                            >
                                <option value="" defaultChecked>{translation?.sebeb_sec}</option>
